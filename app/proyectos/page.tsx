...
export default function ProyectosPage() {
  return (
    <main>
      ...
      <SectionWrapper className="project" delay={0.06}>
        <div>
          <div className="project-num">01</div>
          <h2>Despachos KPIs</h2>
          <h3>Panel web de rendimiento</h3>
          <p>
            App en la nube para subir el Excel de despachos y generar gráficos de rendimiento real vs teórico, CC.OO,
            tractos y conductores. Incluye feedback de carga (“estructurando datos… / creando gráficos…”) y caché para
            respuesta rápida.
          </p>
          <div className="tags">
      ...
      <SectionWrapper className="project" delay={0.04}>
        <div>
